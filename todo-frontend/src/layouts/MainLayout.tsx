...
const MainLayout = () => {
  ...
  const isActive = (href: string) => {
    if (href === '/') {
      // Home route should be active for / and /todos paths
      return location.pathname === '/' || location.pathname.startsWith('/todos');
    }
    // Other routes should be active if pathname starts with href
  ...
  /* copied and modified from tailwind ui */
  return (
    <div className="min-h-full bg-slate-50 h-full flex-1">
      <Disclosure
        as="nav"
